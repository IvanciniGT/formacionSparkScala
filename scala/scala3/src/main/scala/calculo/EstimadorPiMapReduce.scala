...
class EstimadorPiMapReduce(val numero_de_dardos:Int): // Lo que ponemos aquí se recibe en el constructor de la clase
    ...
    def estimar: Double = 
        ...
        var numero_de_dardos_en_el_circulo = (1 to numero_de_dardos).map(       tirarDardo             )
